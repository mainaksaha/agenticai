...
from arcade_arithmetic.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_arithmetic)


@tool_eval()
def arithmetic_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="arithmetic Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to arithmetic tools. "
